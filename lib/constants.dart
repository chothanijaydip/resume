...
const kSocialLinks = [
  "https://facebook.com/100078448894930",
  "https://instagram.com/j_ydip",
  "https://twitter.com/jaydipchothani",
  "https://linkedin.com/in/jaydip-chothani-636628100",
  "https://github.com/chothanijaydip",
  "https://medium.com/@chothanijaydip98"
];
...
// Tools & Tech
final backEnd = ['Node.js', 'Firebase Cloud functions', 'Google Cloud', 'AWS'];
final frontEnd = ['Flutter', 'IOS', 'Android', 'React','Html'];
final database = ['MySql', 'SQLite', 'PostgreSQL', 'Realtime Database','Rethinkdb'];
final database2 = ['Cloud Firestre', 'Hive DB', 'Realm DB'];
final payment = ['In-App Purches', 'Stripe', 'RazorPay', 'Apple Pay','Master Card','APT Pay'];
final designing = ['Figma', 'Adobe XD', 'Sketch','In-VIsion','other'];
final sso = ['Google','Facebook','Apple','Twitter','GitHub','Email','Phone'];
final integration = ['Cloud & On-Promise Apps','Socket.Io','Web Sockets','Docket','Twilio'];
final integration2 = ['Plaid'];
// services
